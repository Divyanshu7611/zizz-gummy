...
//               <img src='/static/logo.png' alt='logo' className='md:w-20 w-12 md:h-12 h-6 object-contain' />
//             </NavLink>
...
//       <SearchToggle />
//       <NavLink prefetch="intent" to="/account" style={activeLinkStyle} className="text-gray-700 hover:text-gray-900 hidden md:block">
...
//       )}
//       <div
//         className={`w-full ${isScrolled ? 'fixed top-0 z-50' : 'relative z-50'}`}
//       >
//         <HeaderTop />
//         <header
