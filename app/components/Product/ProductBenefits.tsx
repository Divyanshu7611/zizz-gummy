...
function ProductBenefits() {
  return (
     <div className='max-w-screen-xl mx-auto flex flex-col py-10 px-3'>
        <div>
            <h1 className='inter md:text-4xl text-2xl font-bold text-center'>Product Benefits & Ingredients</h1>
        </div>

        
        <div className='flex justify-between w-full md:flex-row flex-col gap-3 mt-16'>
